        ...
        <div class="option">
            <div>
                <form onsubmit="searchPlaces(); return false;">
                    키워드 : <input type="text" value="대전 수영장" id="keyword" size="15"> 
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=	2b4755806ea61fe017f1f83619d660ea&libraries=services"></script>
<script>
// 마커를 담을 배열입니다
var markers = [];
